...
## Powermemo Backend
Powermemo offers a [open-source solution](https://github.com/memodb-io/powermemo) with a docker backend to launch your own instance.
You can use `docker-compose` to launch the backend [in one command](https://github.com/memodb-io/powermemo/blob/main/src/server/readme.md#get-started).
