...
## Setup
1. Go to [Powermemo](https://www.powermemo.io/en) for your Powermemo API Key or launch [a local server](https://github.com/memodb-io/powermemo/tree/dev/src/server)
...
> [Full Code](https://github.com/memodb-io/powermemo/blob/main/src/client/powermemo/patch/openai.py)
### Basic Setup
```python
import os
