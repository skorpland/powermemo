...
title: Livekit
---
> [Full Code](https://github.com/memodb-io/powermemo/tree/dev/assets/tutorials/livekit%2Bpowermemo)
...
## Code Breakdown
Full code is available [here](https://github.com/memodb-io/powermemo/tree/dev/assets/tutorials/livekit%2Bpowermemo/livekit_example.py). We're using [livekit 1.0 SDK](https://docs.livekit.io/agents/build/).
